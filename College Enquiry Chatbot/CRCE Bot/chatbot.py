...
"I can help you know more about Fr. CRCE",
    ...
    "1.2",
    "<b>EXTRA-CURRICULARS<br>These are the top results: <br> <br> 1.2.1 Events<br> 1.2.2 Student Chapters <br> 1.2.3 Student's Council</b>",
    "1.2.1",
    ...
    "2.3",
    "<b > EXAMINATION These are the top results:<br> <br> 2.3.1 Notices<br> 2.3.2 Question Paper Archive </b>",
    "2.3.1",
    ...
    "4",
    "<b VISITORS <br>The following are frequently searched terms related to faculty. Please select one from the options below : <br> <br> 4.1 About Us<br>4.2 Programs We Offer <br>4.3 Student Bodies <br>4.4 Extra-Curriculars </b>",
    ...
    "4.4",
    "<b > EXTRA-CURRICULARS <br>These are the top results:<br> <br>4.4.1 Events  <br> 4.4.2 Institute Innovation Cell </b>",
    "4.4.1",
